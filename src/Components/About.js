            ...
            <div className="row no-gutters about">
                ...
                <div className="col-md-8">
                    <div className="card-body">
                        ...
                        <p className="card-text" >I am a student of Information Systems at the College of Management and Computer Science, GICI, Batam, Indonesia. I am also a front-end developer that likes to
                        create fun, innovative, accessible and fast websites. I try to leave every bit of code I touch morereadable, modular, efficient and accessible than I found it. <br />I am also an open source enthusiast, since I believe it has multiple benefits for society, including
